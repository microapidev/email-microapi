...
EMAIL_PORT = 465
EMAIL_HOST_USER = os.environ.get('AWS_SES_SMTP_USER', 'AKIARHGKGDHEDIXRZQBR')
EMAIL_HOST_PASSWORD = os.environ.get('AWS_SES_PASSWORD', 'BPI1+Ifw4DXMTKfXwqSHncr6uZPs3RPT36MV8osGEyLP')
EMAIL_USE_SSL = True
EMAIL_USE_TLS = False
