/*! KEditor v2.0.1 | Copyright (c) 2016-present Kademi (http://kademi.co) */ ! function (t, n) {
    if ("object" == typeof exports && "object" == typeof module) module.exports = n(require("jQuery"));
    ...
    return function (t) {
        ...
        return e.m = t, e.c = n, e.d = function (t, n, o) {
            ...
            if (e.r(o), Object.defineProperty(o, "default", {
                ...
                for (var a in t) e.d(o, a, function (n) {
                    return t[n]
                }.bind(null, a));
            return o
        }, e.n = function (t) {
        ...
        var o = e(1),
            ...
            i = {
                ...
                snippetsUrl: window.location.protocol + "//" + window.location.host +"/v1/snippets/",
        ...
        var h = function (t) {
            ...
            $(t).filter("div").each((function () {
                var t = $(this),
                    ...
                    s = n.getDataAttributes(t, ["data-preview", "data-type", "data-keditor-title", "data-keditor-categories"], !0),
        ...
        var v = function () {
                ...
                var i, r = a.find(".".concat(c.SNIPPETS_SEARCH)),
                    ...
                    s = function () {
                        ...
                        a.filter(".".concat(c.STATE_SELECTED)).removeClass(c.STATE_SELECTED), e || o ? a.each((function () {
                            var t = $(this),
                                ...
                                r = 0;
                            (e && -1 === $.inArray(e, i) && r++, o) && (-1 === t.attr("data-keditor-title").toLowerCase().indexOf(o) && -1 === a.indexOf(o) && r++);
            ...
            B = function (t) {
                ...
                return e && e in KEditor.components || ("string" == typeof n.defaultComponentType ? e = n.defaultComponentType : "function" == typeof n.defaultComponentType && (e = n.defaultComponentType.call(this, t)), e || this.error("Component type is undefined!")), e
            },
            M = function (t) {
                var n = this,
                    e = n.options,
            ...
            Z = function (t) {
                ...
                } else if (t.is(".".concat(c.CONTAINER))) z.call(this, t, null, x.CONTAINER, n.locale.containerSetting, n.containerSettingInitFunction, n.containerSettingShowFunction, this);
                else {
        ...
        var at = function (t) {
            ...
            lt = function () {
                var t = this,
                    n = t.options,
                    e = t.btnSave = $('<a href="javascript:void(0);" title="'.concat(n.locale.send, '" class="').concat(c.UI, " ").concat(c.TOPBAR_BUTTON, '">').concat(D.SEND, "</a>"));
                e.on("click", (function (e) {
                    ...
                    var primaryKey = $('#u_id').val();
                    var recipient = $('#email').val();
                    var subject = $('#subject').val();
                    if($.trim($('#email').val()) == '') {
                        $("#message_p").html("<p class='alert alert-danger' style='text-align:center;'>E-mail field is empty</"+"p"+"><br><input value=' "+subject +"' class='form-control' type='text' id='subject' placeholder='Please Enter subject' style='margin-top:0px;margin-left:2%; width:300px !important;height:50px; float:left'><input value=' "+recipient +"' class='form-control' type='email' id='email' placeholder='Please Enter e-mail address of receiver' style='margin-top:0px;padding-left:5%; width:400px !important;height:50px'>");
                    }else{
                        if( !validateEmail(recipient)){
                            $("#message_p").html("<p class='alert alert-danger' style='text-align:center;'>Enter valid E-mail</"+"p"+"><br><input value=' "+subject +"' class='form-control' type='text' id='subject' placeholder='Please Enter subject' style='margin-top:0px;margin-left:2%; width:300px !important;height:50px; float:left'><input value=' "+recipient +"' class='form-control' type='email' id='email' placeholder='Please Enter e-mail address of receiver' style='margin-top:0px;padding-left:5%; width:400px !important;height:50px'>");
                         }else{
                             if(subject == ''){
                                $("#message_p").html("<p class='alert alert-danger' style='text-align:center;'>Subject field cannot be empty</"+"p"+"><br><input value=' "+subject +"' class='form-control' type='text' id='subject' placeholder='Please Enter subject' style='margin-top:0px;margin-left:2%; width:300px !important;height:50px; float:left'><input value=' "+recipient +"' class='form-control' type='email' id='email' placeholder='Please Enter e-mail address of receiver' style='margin-top:0px;padding-left:5%; width:400px !important;height:50px'>");
                             }else{
                                $.ajax({

                                    type: "PUT",
                                    url: window.location.protocol + "//" + window.location.host +"/v1/profile/"+ primaryKey+"/",
                                    contentType: "application/json",
                                    dataType: "json",
                                    data: JSON.stringify({
                                           //   action: "send-content",
                                            content: $('#content-area').keditor('getContent'),
                                            recipient : $.trim($('#email').val()),
                                            subject : subject
                                    }),
                                    success: function(response) {
                                     //    console.log(response);
                                     if(response == "Newsletter sent"){
                                         $("#message_p").html("<p class='alert alert-success' style='text-align:center;'>"+response+"</"+"p"+">");
                                     }else{
                                         $("#message_p").html("<p class='alert alert-danger' style='text-align:center;'>"+response+"</"+"p"+">");
                                     }
                                    ...
                                    error: function(response) {
                                     //    console.log(response);
                                        ...
                                        // $("#message_p").html("<p class='alert alert-danger' style='text-align:center'>Error occured, try again</p>");
                                    }       
            ...
            Tt = function () {
                ...
                $.isPlainObject(t.extraTopbarItems) && $.each(t.extraTopbarItems, (function (t, e) {
                    var o = $(e.html);
                    o.addClass("keditor-ui keditor-topbar-btn keditor-topbar-btn-".concat(t)), o.on("click", e.click), n.append(o)
                }))
            },
            Et = function () {
                var t = s(),
                ...
                t.contentAreasWrapper.on("click", ".".concat(c.CONTAINER_DELETE), (function (e) {
                    ...
                    if (confirm(n.locale.confirmDeleteContainerText)) {
                        var a = o.closest(".".concat(c.CONTAINER)),
                            ...
                            r = a.closest(".".concat(c.CONTENT_AREA));
                        if ("function" == typeof n.onBeforeContainerDeleted && n.onBeforeContainerDeleted.call(t, e, a, r), t.settingComponent) t.settingComponent.closest(".".concat(c.CONTAINER)).is(a) && Y.call(t);
            ...
            Ut = function (t, n) {
                ...
                var a = t.html(),
                    i = $('<div class="'.concat(c.CONTENT_AREA_INNER, '"></div>')).html(a);
            ...
            Wt = function (t, n) {
                this.element = t, this.options = $.extend({}, i, n), Ft.call(this), Et.call(this), X.call(this), H.call(this), Q.call(this), this.id = s(), KEditor.instances[this.id] = this, "function" == typeof this.options.onReady && this.options.onReady.call(this)
            },
            $t = function () {
                var t = this.element,
                    n = this.id,
                    e = at.call(this, !1);
                this.wrapper.remove(), t.is("textarea") ? t.val(e) : t.html(e), t.removeClass(c.UI_HIDDEN), t.data("keditor", null), delete KEditor.instances[n]
            },
            Vt = function (t, n) {
        ...
        if (!a.a.fn.sortable) throw new Error("[ KEditor ] $.fn.sortable does not exist. Please import $.fn.sortable into your document for continue using KEditor.");
        ...
        jt(Ht, "DEFAULTS", i), jt(Ht, "debug", !1), jt(Ht, "version", "2.0.1"), jt(Ht, "instances", {}), jt(Ht, "components", {
            blank: {
                settingEnabled: !1
            }
            ...
            var n = a()(this),
                e = n.data("keditor");
            return "string" != typeof t ? (e || (e = Ht.init(n, t), n.data("keditor", e)), e) : e && e[t] && "function" == typeof e[t] ? e[t].apply(e, Array.prototype.slice.call(arguments, 1)) : void 0
