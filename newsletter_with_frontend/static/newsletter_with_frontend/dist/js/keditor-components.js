/*! KEditor v2.0.1 | Copyright (c) 2016-present Kademi (http://kademi.co) */ ! function (t, o) {
    ...
    return function (t) {
        ...
        t.exports = e
    }, , function (t, o, e) {}, function (t, o, e) {}, , function (t, o, e) {
        "use strict";
        e.r(o);
        var n = e(0),
            i = e.n(n);
        ...
        i.a.components.form = {
            ...
            initModal: function (t) {
                var o = this;
                (a = t.initModal("keditor-modal-form")).find(".keditor-modal-title").html("Design form"), a.css({
                    visibility: "hidden",
                    display: "block",
                    opacity: 1
            ...
            initSettingForm: function (t, o) {
                ...
                n.on("click", (function (t) {
                    ...
                    if (/image/.test(n.type)) {
                        ...
                        i.addEventListener("load", (function (n) {
                            ...
                            i.attr("src", n.target.result), i.css({
                                width: "",
                                height: ""
                            }), i.load((function () {
                ...
                a.on("change", (function () {
                    ...
                    n <= 0 && (n = e.width, i = e.height, this.value = n), t.css({
                        width: n,
                        height: i
                    }), l.val(i)
                    ...
                    var t = o.getSettingComponent().find("img"),
                        n = +this.value,
                        i = Math.round(n * e.ratio);
                    n <= 0 && (i = e.width, n = e.height, this.value = n), t.css({
                        height: n,
                        width: i
                    }), a.val(i)
                }))
        ...
        var d = e(2),
            c = e.n(d);
        c.a.disableAutoInline = !0, c.a.dom.element.prototype.scrollIntoView = function () {}, c.a.dom.selection.prototype.scrollIntoView = function () {}, c.a.dom.range.prototype.scrollIntoView = function () {}, i.a.components.text = {
            options: {
                toolbarGroups: [{
                    name: "document",
            ...
            init: function (t, o, e, n) {
                ...
                l.on("instanceReady", (function () {
                    ...
                    (t.data.domEvent.$.ctrlKey && 86 === t.data.domEvent.$.keyCode || 13 === t.data.domEvent.$.keyCode) && (console.log("Dont scroll!!"), n.iframeBody.scrollTop($(l.element.$).offset().top), setTimeout((function () {}), 10))
                }), l)
            },
